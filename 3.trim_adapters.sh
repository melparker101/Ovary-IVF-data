...
PE \
$fastq/IVF00"$INPUT_FILE"_R1_001.fastq.gz \
$fastq/IVF00"$INPUT_FILE"_R2_001.fastq.gz \
$OUT/IVF00"$INPUT_FILE"_R1_001_trimmed_P.fastq.gz \
$OUT/IVF00"$INPUT_FILE"_R1_001_trimmed_U.fastq.gz \
$OUT/IVF00"$INPUT_FILE"_R2_001_trimmed_P.fastq.gz \
$OUT/IVF00"$INPUT_FILE"_R2_001_trimmed_U.fastq.gz \
