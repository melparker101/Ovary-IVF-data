...
echo "Creating sample index for the raw reads"
...
echo "Generating RSEM reference."

# M. quantification_rsem.sh

echo "Quantifying genes and isoforms using RSEM."

# N. DESeq2

echo "Running downstream analysis using DESeq2."
